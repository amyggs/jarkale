const CACHE='jarkale-v123';const FILES=['./', './index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
// Pakkolataus: uusi SW ottaa hallinnan heti ilman odottelua
